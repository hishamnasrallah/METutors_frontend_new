...
export class CometChatOutgoingDirectCallComponent implements OnInit, OnChanges {
  ...
  ngOnChanges(change: SimpleChanges) {
    ...
    try {
      if (change[enums.OUTGOING_DIRECT_CALL]) {
        ...
        props[enums.OUTGOING_DIRECT_CALL] =
          change[enums.OUTGOING_DIRECT_CALL].currentValue;
      ...
      if (change[enums.INCOMING_DIRECT_CALL]) {
        ...
        props = {
          ...props,
          ...change[enums.INCOMING_DIRECT_CALL].currentValue
        };

        if (
          prevProps.incominDirectCall !== this.incomingDirectCall &&
