...
import { CometChatReceiverDirectCallBubbleComponent } from './CometChat-receiver-directcall-bubble/cometchat-receiver-directcall-bubble.component';
...
@NgModule({
  ...
  exports: [CometChatReceiverDirectCallBubbleComponent]
})
export class CometChatReceiverDirectCallBubble {}
