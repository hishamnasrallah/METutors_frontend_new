...
@Component({
  selector: 'metutors-student-resources-upload-document-modal',
  templateUrl: './student-resources-upload-document-modal.component.html',
  styleUrls: ['./student-resources-upload-document-modal.component.scss'],
})
export class StudentResourcesUploadDocumentModalComponent implements OnInit {
